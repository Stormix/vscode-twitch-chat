...
import { getTwitchSettings } from '../config/twitch';
...
export class ViewLoader {
  ...
  constructor(context: vscode.ExtensionContext) {
    ...
    this.panel = vscode.window.createWebviewPanel('reactApp', 'React App', vscode.ViewColumn.One, {
      ...
      localResourceRoots: [vscode.Uri.file(path.join(this.context.extensionPath, 'out', 'webview'))],
    });
  ...
  render() {
    const bundleScriptPath = this.panel.webview.asWebviewUri(
      vscode.Uri.file(path.join(this.context.extensionPath, 'out', 'webview', 'index.js'))
    );
      ...
      <!DOCTYPE html>
        ...
        <body>
          ...
          <script>
            ...
            const twitchSettings = ${JSON.stringify(twitchSettings)};
          </script>
          <script>
            console.log('twitchSettings', twitchSettings)
          </script>
